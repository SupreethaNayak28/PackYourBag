        ...
        return true;
                ...
                new AlertDialog.Builder( this)
                 .setTitle("Delete default data")
                    .setMessage("Are you sure? \n\nAs this will delete the data provided by (Pack Your Bag )while installing and " +
                            "( "+header+" )")
            ...
            new AlertDialog.Builder( this)
                    ...
                    .setMessage("Are you sure? \n\nAs this will load the data provided by (Pack Your Bag ) and " +
                            "( "+header+" )")
                    .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
           ...
           return true;
            ...
            this.finishAffinity();
            Toast.makeText(this,"Exited successfully\n",Toast.LENGTH_SHORT).show();
            return true;
        }
        else
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(itemName!=null&&!itemName.isEmpty()){
                    ...
                    Toast.makeText(CheckList.this,"Please enter an item, to add",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
